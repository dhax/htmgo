        ...
        The structure of this comes down to:
       	...
       	2. Add commands (found in the <b>'js'</b> package) as children to that event handler
			...
			h.P(
				...
				Link("lifecycle.", "https://github.com/dhax/htmgo/blob/master/framework/h/lifecycle.go"),
			...
			h.P(
				...
				Link("here.", "https://github.com/dhax/htmgo/blob/master/framework/js/commands.go"),
			),
